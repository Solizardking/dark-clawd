...
/**
 * @title React AI Environment Variables
 ...
 * @description React AI environment variables component for displaying and managing env vars with visibility toggle
 * @opening Show environment variables in your AI interface—perfect for setup guides, configuration displays, or secrets management. Displays key-value pairs with masked values by default, a toggle to reveal them, and copy buttons. Required variables get highlighted badges. Great for onboarding flows, API key displays, or any configuration the user needs to see.
 * @related [
 *   {"href":"/ai/snippet","title":"React AI Snippet","description":"Copyable code snippets"},
 ...
 * ]
 * @questions [
 *   {"id":"envvars-toggle","title":"How do I toggle value visibility?","answer":"Use EnvironmentVariablesToggle in the header. It shows an eye icon switch that controls visibility for all values. Pass showValues/onShowValuesChange for controlled mode."},
 *   {"id":"envvars-copy","title":"How do users copy values?","answer":"Add EnvironmentVariableCopyButton inside EnvironmentVariable. Set copyFormat to 'value' (default), 'name', or 'export' (copies as 'export NAME=value')."},
 *   {"id":"envvars-required","title":"How do I mark required variables?","answer":"Add EnvironmentVariableRequired badge next to the variable name. It renders a 'Required' badge that helps users identify which variables are mandatory."},
 *   {"id":"envvars-masked","title":"How are values masked?","answer":"Values show as bullet points (•) when hidden. Length is capped at 20 characters for display. Toggle reveals actual values."}
 * ]
 */
