...
program
  ...
  .action(async () => {
    ...
    if (autoEnabled && autoPresent) {
      console.log(chalk.magenta('Automaton bridge ready · dark-clawd automaton status'));
    }
  });
...
// ─────────────────────────────────────────────────────────────────────────────
// Automaton bridge (vendored sovereign runtime under ./automaton)
// ─────────────────────────────────────────────────────────────────────────────
...
automatonCmd
  ...
  .action(() => {
    const report = formatAutomatonStatusReport(getAutomatonIntegrationStatus());
...
automatonCmd
  .command('paths')
  .description('List Automaton tree entrypoints used by Dark Clawd')
  .action(() => {
...
// Default subcommand for `dark-clawd automaton`
automatonCmd.action(() => {
