...
/** Resolve the Dark Clawd package root (repo workspace root for this product). */
...
/**
 * Resolve vendored automaton/ (env override, package-local, or sibling of tui/).
 */
...
export function getAutomatonIntegrationStatus(
  ...
  return {
    ...
    lineageNote:
      'Vendored under dark-ralph/automaton. Constitution is Clawd-branded (shell molts / laws do not). Product surface: Dark Clawd, forged from Ralph on Solana.',
  };
}
